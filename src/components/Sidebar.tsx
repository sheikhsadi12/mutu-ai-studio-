...
import { Library, Music, Settings, X, Archive, Loader2, DownloadCloud, Palette, Fingerprint, Sparkles, Zap, Disc, Waves, Mic, MoreVertical } from 'lucide-react';
            ...
            <AnimatePresence>
              {isMenuOpen && (
                <motion.div
                  ...
                  className="absolute right-0 bottom-full z-50 mb-2 w-40 overflow-hidden rounded-lg border border-[var(--color-glass-border)] bg-[var(--color-cyber-black)] shadow-xl"
                >
                  <div className="flex flex-col p-1.5">
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-[10px] font-bold uppercase tracking-wider text-[var(--color-text-primary)] hover:bg-[var(--color-bg-hover)] disabled:opacity-50"
                    >
                      {isDownloading ? <Loader2 size={12} className="animate-spin" /> : <Archive size={12} />}
                    ...
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-[10px] font-bold uppercase tracking-wider text-[var(--color-text-primary)] hover:bg-[var(--color-bg-hover)]"
                    >
                      <Fingerprint size={12} />
                      <span>App Icon</span>
                    </button>
